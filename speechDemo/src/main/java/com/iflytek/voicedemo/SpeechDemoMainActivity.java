...
public class SpeechDemoMainActivity extends Activity implements OnClickListener {

	private static final String TAG = SpeechDemoMainActivity.class.getSimpleName();
	...
	public void onClick(View view) {
		...
		case 0:
			// 语音转写
			intent = new Intent(SpeechDemoMainActivity.this, IatDemo.class);
			break;
		case 1:
			// 语法识别
			intent = new Intent(SpeechDemoMainActivity.this, AsrDemo.class);
			break;
		case 2:
			// 语义理解
		...
		case 3:
			// 语音合成
			intent = new Intent(SpeechDemoMainActivity.this, TtsDemo.class);
			break;
		case 4:
			// 语音评测
			intent = new Intent(SpeechDemoMainActivity.this, IseDemo.class);
			break;
		case 5:
			// 唤醒
		...
		case 6:
			// 声纹
			intent = new Intent(SpeechDemoMainActivity.this, VocalVerifyDemo.class);
			break;
		case 7:
			intent = new Intent(SpeechDemoMainActivity.this,OnlineFaceDemo.class);
			break;
		/*case 8:
			Intent init = new Intent(SpeechDemoMainActivity.this, UrlSettings.class);
	...
	private class SimpleAdapter extends BaseAdapter {
		public View getView(int position, View convertView, ViewGroup parent) {
			if (null == convertView) {
				LayoutInflater factory = LayoutInflater.from(SpeechDemoMainActivity.this);
				View mView = factory.inflate(R.layout.list_items, null);
				convertView = mView;
			}
			
			Button btn = (Button) convertView.findViewById(R.id.btn);
			btn.setOnClickListener(SpeechDemoMainActivity.this);
			btn.setTag(position);
	...
	protected void onResume() {
		// 开放统计 移动数据统计分析
		FlowerCollector.onResume(SpeechDemoMainActivity.this);
	...
	protected void onPause() {
		...
		FlowerCollector.onPause(SpeechDemoMainActivity.this);
		super.onPause();
	}
